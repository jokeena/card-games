...
A future euchre game should mirror this shape under `src/games/euchre/` with its own engine — do not generalize the pinochle engine to serve both (bowers break its trick-legality and rank assumptions).
